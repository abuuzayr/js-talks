...
| In the land of the JavaScripters | Havi Hoffman | [:arrow_forward:](https://youtu.be/1gL8u0gmWdg) | [:arrow_right:](https://js-talks.netlify.app/posts/in-the-land-of-the-javascripters) | :white_check_mark: |
| করো: Translating Code to Other (Human) Languages, and Back Again | Aditya Mukerjee | [:arrow_forward:](https://youtu.be/-0WQCs2JsFY) | [:arrow_right:](https://js-talks.netlify.app/posts/translating-code-to-other-human-languages-and-back-again) | :white_check_mark: |
| Crafting Comics for Literally Everyone | Jessica Jordan | [:arrow_forward:](https://youtu.be/BPmuR4mAQaw) | [:arrow_right:](https://js-talks.netlify.app/posts/crafting-comics-for-literally-everyone) | :white_check_mark: |